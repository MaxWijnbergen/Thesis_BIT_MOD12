...
# This code calculates the Jaccard index for the summary file with unique CWEs for every text file. It counts the total of the specific TTP, of the specific CWE and the intersection and calculates the Jaccard index accordingly
...
output_filepath = 'jaccard_indices_final_no_dup.txt'
